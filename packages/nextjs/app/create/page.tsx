...
const CreateContract: NextPage = () => {
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      if (!txHash) throw new Error("Transaction failed to start");
      if (!publicClient) throw new Error("Public client not found");
      const receipt = await publicClient.waitForTransactionReceipt({ hash: txHash });

      const chainId = publicClient.chain.id;
      const factoryAbi = (deployedContracts as any)[chainId].EscrowFactory.abi;
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                <div className="space-y-6">
                  ...
                  <div className="form-control w-full">
                    ...
                    <input
                      type="text"
                      className="input input-bordered w-full bg-base-200 rounded-sm"
                      disabled
                  ...
                  <div className="form-control w-full">
                    ...
                    <p className="text-[9px] mt-1 opacity-50 italic">
                      Tip: If QR scan fails, crop the image to just the QR code.
                    </p>
                  </div>
                ...
                <div className="card-body relative z-10">
                  ...
                  <div className="mt-4 space-y-4">
                    <div className="flex justify-between items-center border-b border-primary-content/20 pb-2">
                      ...
                      <span className="text-xl font-bold">{totalAmount || "0.00"} MON</span>
                    </div>
              ...
              <div className="card bg-base-100 shadow-lg border border-secondary/20 p-4 rounded-sm">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-sm">
                    <div
                      className={`p-1.5 rounded-full ${poCid ? "bg-success/20 text-success" : "bg-base-200 opacity-50"}`}
                    >
                  ...
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className={isDeploying ? "font-medium" : "opacity-50"}>
                      {isDeploying ? "Deploying..." : "Ready to Deploy"}
                    </span>
                  </div>
                </div>
              </div>
