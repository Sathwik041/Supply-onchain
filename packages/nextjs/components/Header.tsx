...
export const Header = () => {
  ...
  return (
    <div className="sticky lg:static top-0 navbar bg-base-100/70 backdrop-blur-md border-b border-base-content/10 min-h-0 shrink-0 justify-between z-20 shadow-md shadow-secondary px-1 sm:px-2">
