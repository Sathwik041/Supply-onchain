...
const deployedContracts = {
  10143: {
    EscrowFactory: {
      address: "0x2422aE1aaaf07695761774065cc2B6AceA2867A5",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 22243636,
    },
    MachinePassport: {
      address: "0x6109726F5a1cfFfd5A05A69cD77F1Ef96d18346E",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
      ...
      deployedOnBlock: 22243610,
    },
    SupplyChainEscrow: {
      address: "0x75bB67D2E2707fAB568259d40BCdC11653C2EdDf",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
